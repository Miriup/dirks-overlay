...
# locales
	cd po
	emake DESTDIR="${ED}/usr" DATADIR=share install
	cd ..
...
#   ^locale_base = None
	...
	dodir "${python_site#${EPREFIX}}/fslint"
	echo "liblocation = '${EPREFIX}/usr/share/fslint/'" > ${D}/$python_site/fslint/__init__.py
...
pkg_postinst() {
	...
	einfo "${EPREFIX}/usr/share/fslint/fslint"
